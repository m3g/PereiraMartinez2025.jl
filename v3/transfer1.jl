...
## SH3 in aqueous solutions of TMAO
...
tmao_fit = fitquadratic(ustrip(tmao_data[!,:m₃]),log.(tmao_data[!,:γ₃]))
...
#=
### Computing the transfer free energy of SH3 in the native state
...
#=
### Preferential interaction parameters from the simulation
