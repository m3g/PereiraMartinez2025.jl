...
# ╔═╡ c3e97f25-3d76-4798-8e53-4247cfbe76be
using CSV
...
# ╔═╡ 16383a34-4242-4dee-8407-604133d9b37f
using ColorSchemes
...
∂g₃∂g₂ = DataFrame(
	"N" => [ 0.7322413729167361, 1.234061348004341, 1.6869506028367725, 2.309289718798011, 2.874253919334296, 4.106324454718564, 5.247095311466286 ] / (M2/M3),
	"U1" => [ 0.7738472849591347, 1.4493154865284774, 2.0494586566884174, 2.8964714408204486, 3.6192731928074218, 4.530201676029208, 6.0576057564457075 ] / (M2/M3),
	"U2" => [ 0.949145569258887, 1.9611304243274124, 2.925069641569596, 3.689785944320877, 4.533721029172277, 6.983675813075196, 8.912112675526776 ] / (M2/M3)	
)
...
The difference increases with increasing urea concentration. At higher urea concentrations the integrals associated with the denatured states become progressively more negative, thus the denatured states are stabilized relative to the native state upon transfer to a urea solution. 
"""
...
c = DataFrame(
        "N" => [ 0.09428278077660132, 0.19716895780546348, 0.28977002209160585, 0.396725811287025, 0.49484855460526395, 0.7414000240240834, 1.012065497506531 ]u"mol/L",
	"U1" => [ 0.0979132535434109, 0.19717867556799268, 0.2932911022168221, 0.393110794058266, 0.4957252553327455, 0.7396967231485789, 1.0043949504996528 ]u"mol/L",
	"U2" => [ 0.09625536638758064, 0.19455202579079775, 0.29301987737319485, 0.38626269852419726, 0.49329352096683826, 0.7390601285373102, 1.0015536563680936 ]u"mol/L"	
)
...
#CSV.write("./sh3_urea_delta_mu_values.csv", df)
...
# ╔═╡ c43b7e6e-1f28-4ebb-a796-65b8a56952fc
VERSION
